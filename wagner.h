...
void   hyptrav(node2 *, boolean, bitptr, long, boolean, boolean, bitptr, bitptr, bitptr, pointptr2, Char *, gbit *);
void   hypstates(long, boolean, boolean, boolean, node2 *, bitptr, bitptr, bitptr, pointptr2, Char *, gbit *);
void   drawline(long, double, node2 *);
void   writesteps(boolean weights, steptr numsteps);
void   printree(boolean treeprint, boolean noroot, boolean didreroot, node2 *);
/* function prototypes */
#endif
