...
void            phylipinit(int argc, char** argv, initdata* ini, boolean);
void            scan_eoln(FILE *);
...
void            inputNumbersFromTreeFile(FILE *, long * spp, long * nonodes);
...
void            addelement(tree *, node **, node *, Char *, long *, FILE *, pointarray,
                           boolean *, boolean *, long *, long *, boolean *, initptr,boolean,long);
